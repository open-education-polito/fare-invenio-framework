...
Report bugs at https://github.com/open-education-polito/fare-platform/issues.
...
https://github.com/open-education-polito/fare-platform/issues.
...
1. Fork the `open-education-polito/fare-platform` repo on GitHub.
...
3. The pull request should work for Python 2.7, 3.3, 3.4 and 3.5. Check
   https://travis-ci.org/open-education-polito/fare-platform/pull_requests
